      ...
      <Container maxWidth="sm" className="p-16">
        <Grid container>
          <Grid item xs={7} className="p-16">
            <Stack spacing={2}>
              <Typography variant="h3">Create Beer</Typography>
                ...
                >
                  <Grid item xs={6} className="pl-0">
                    <TextField
                      ...
                      onChange={(e) =>
                        handlerIngredientChange(index, { name: e.target.value })
                      }
                      size="small"
                      fullWidth
                    />
                  ...
                  <Grid item xs={3}>
                    <TextField
                      ...
                      onChange={(e) =>
                        handlerIngredientChange(index, { unit: e.target.value })
                      }
                      size="small"
                      fullWidth
                    />
